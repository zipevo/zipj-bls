...
import org.zipj.bls.Utils.HexUtils;
...
public class PrivateKeyTest extends BaseTest {
    ...
    public void multiplicationOperatorTest() {
        ...
        G1Element publicKeyFirst1 = ZIPJBLS.multiply(publicKey1, pk2);
        G1Element privateKeyFirst1 = ZIPJBLS.multiply(pk2, publicKey1);
        G1Element publicKeyFirst2 = ZIPJBLS.multiply(publicKey2, pk1);
        G1Element privateKeyFirst2 = ZIPJBLS.multiply(pk1, publicKey2);
